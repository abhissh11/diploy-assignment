...
export default function Hero() {
  ...
  return (
    <>
      <div className="relative pt-20 mx-5 md:mx-20 flex flex-col gap-4 md:flex-row md:justify-between justify-evenly items-center h-svh">
        <div className="flex flex-col md:items-start items-center justify-center">
          ...
          <div className=" flex flex-col gap-3">
            ...
            {/* video here rendered  */}
            {demoVideo && (
              <div className="absolute top-36 md:bottom-24  right-0">
                <button
                  onClick={handleDemoClick}
